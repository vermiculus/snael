...
\cite{Inniss06:nlp-bioapplications,lapata05:web-nlp,church95:commerical-nlp}
...
\cite{shaket77:shrdlu}.  Its development has led to such useful tools
such as \textit{Wolfram~Alpha}, a self-proclaimed,
natural-language-driven ``computational knowledge engine''
\cite{gray12:wolfram}, IBM's amazing \textit{Watson}
\cite{ferrucci11:watson}, and even \textit{Google}'s famous search
engine \cite{kammerer12:google}.  As such, there are many tools
...
available on the internet) called the \ac{nltk} \cite{bird09:nltk}.
...
\cite{bird08:nltk}.  This toolkit is just a beginning.
